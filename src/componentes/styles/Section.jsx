...
function Card2(props) {
  return (
    <motion.div
      ...
      className={`relative border border-transparent hover:border hover:border-solid rounded-[50%] m-2 py-6 px-7  align-middle text-center bg-[#3333336b] dark:bg-[#181717] 
        ${props.className || ""}`}
      style={{
